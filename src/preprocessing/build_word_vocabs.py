...
# determine the frequencies of words in the src and trg corpuses, so can decide which ones to keep and which can get away with discarding (replacing with <unknown> tokens), so that vocab is not insurmountably large.
